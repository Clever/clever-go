...
// GetDistrictParams contains all the bound params for the get district operation
...
func (o *GetDistrictParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
