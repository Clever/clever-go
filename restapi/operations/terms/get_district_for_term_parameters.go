...
// GetDistrictForTermParams contains all the bound params for the get district for term operation
...
func (o *GetDistrictForTermParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
