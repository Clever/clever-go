...
func (o *GetResourcesForSectionURL) WithBasePath(bp string) *GetResourcesForSectionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetResourcesForSectionURL) Build() (*url.URL, error) {
	...
	var _path = "/sections/{id}/resources"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetResourcesForSectionURL")
	}
...
func (o *GetResourcesForSectionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetResourcesForSectionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetResourcesForSectionURL")
	}
