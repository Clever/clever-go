...
// GetDistrictForSectionParams contains all the bound params for the get district for section operation
...
func (o *GetDistrictForSectionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDistrictForSectionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
