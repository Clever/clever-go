...
// GetTermForSectionParams contains all the bound params for the get term for section operation
...
func (o *GetTermForSectionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
