...
// GetSectionParams contains all the bound params for the get section operation
...
func (o *GetSectionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
