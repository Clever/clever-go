...
func (o *GetCourseForSectionURL) WithBasePath(bp string) *GetCourseForSectionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetCourseForSectionURL) Build() (*url.URL, error) {
	...
	var _path = "/sections/{id}/course"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetCourseForSectionURL")
	}
...
func (o *GetCourseForSectionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetCourseForSectionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetCourseForSectionURL")
	}
