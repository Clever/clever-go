...
func (o *GetDistrictForSectionURL) WithBasePath(bp string) *GetDistrictForSectionURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDistrictForSectionURL) Build() (*url.URL, error) {
	...
	var _path = "/sections/{id}/district"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetDistrictForSectionURL")
	}
...
func (o *GetDistrictForSectionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDistrictForSectionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDistrictForSectionURL")
	}
