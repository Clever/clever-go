...
func (o *GetSectionsForCourseURL) WithBasePath(bp string) *GetSectionsForCourseURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetSectionsForCourseURL) Build() (*url.URL, error) {
	...
	var _path = "/courses/{id}/sections"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetSectionsForCourseURL")
	}
...
func (o *GetSectionsForCourseURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSectionsForCourseURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSectionsForCourseURL")
	}
