...
func (o *GetDistrictForCourseURL) WithBasePath(bp string) *GetDistrictForCourseURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetDistrictForCourseURL) Build() (*url.URL, error) {
	...
	var _path = "/courses/{id}/district"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetDistrictForCourseURL")
	}
...
func (o *GetDistrictForCourseURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetDistrictForCourseURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetDistrictForCourseURL")
	}
