...
func (o *GetSchoolsForCourseURL) WithBasePath(bp string) *GetSchoolsForCourseURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetSchoolsForCourseURL) Build() (*url.URL, error) {
	...
	var _path = "/courses/{id}/schools"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetSchoolsForCourseURL")
	}
...
func (o *GetSchoolsForCourseURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSchoolsForCourseURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSchoolsForCourseURL")
	}
