...
// GetCourseParams contains all the bound params for the get course operation
...
func (o *GetCourseParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
