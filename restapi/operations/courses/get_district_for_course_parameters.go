...
// GetDistrictForCourseParams contains all the bound params for the get district for course operation
...
func (o *GetDistrictForCourseParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDistrictForCourseParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
