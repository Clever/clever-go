...
func (o *GetResourcesForUserURL) WithBasePath(bp string) *GetResourcesForUserURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetResourcesForUserURL) Build() (*url.URL, error) {
	...
	var _path = "/users/{id}/resources"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetResourcesForUserURL")
	}
...
func (o *GetResourcesForUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetResourcesForUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetResourcesForUserURL")
	}
