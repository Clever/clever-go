...
func (o *GetStudentsForUserURL) Build() (*url.URL, error) {
	...
	var _path = "/users/{id}/mystudents"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetStudentsForUserURL")
	}
...
func (o *GetStudentsForUserURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetStudentsForUserURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetStudentsForUserURL")
	}
