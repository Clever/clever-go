...
func (o *GetSectionsForResourceURL) WithBasePath(bp string) *GetSectionsForResourceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetSectionsForResourceURL) Build() (*url.URL, error) {
	...
	var _path = "/resources/{id}/sections"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetSectionsForResourceURL")
	}
...
func (o *GetSectionsForResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSectionsForResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSectionsForResourceURL")
	}
