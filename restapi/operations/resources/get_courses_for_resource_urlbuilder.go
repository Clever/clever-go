...
func (o *GetCoursesForResourceURL) WithBasePath(bp string) *GetCoursesForResourceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetCoursesForResourceURL) Build() (*url.URL, error) {
	...
	var _path = "/resources/{id}/courses"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetCoursesForResourceURL")
	}
...
func (o *GetCoursesForResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetCoursesForResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetCoursesForResourceURL")
	}
