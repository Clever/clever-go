...
func (o *GetUsersForResourceURL) WithBasePath(bp string) *GetUsersForResourceURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetUsersForResourceURL) Build() (*url.URL, error) {
	...
	var _path = "/resources/{id}/users"

	id := o.ID
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on GetUsersForResourceURL")
	}
...
func (o *GetUsersForResourceURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetUsersForResourceURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetUsersForResourceURL")
	}
