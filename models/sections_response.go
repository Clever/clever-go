...
func (m *SectionsResponse) validateData(formats strfmt.Registry) error {
...
func (m *SectionsResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *SectionsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SectionsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
