...
func (m *ResourcesResponse) validateData(formats strfmt.Registry) error {
...
func (m *ResourcesResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *ResourcesResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ResourcesResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
