...
// WithDefaults hydrates default values in the get event params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEventParams) WithDefaults() *GetEventParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get event params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetEventParams) SetDefaults() {
...
func (o *GetEventParams) WithID(id string) *GetEventParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get event params
func (o *GetEventParams) SetID(id string) {
	o.ID = id
}
